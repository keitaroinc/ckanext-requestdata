...
organization = Blueprint(u'requestdata_organization', __name__,
                         url_prefix=u'/organization',
                         url_defaults={u'group_type': u'organization',
                                       u'is_organization': True})


def requested_data(id, group_type, is_organization):
...
organization.add_url_rule(u'/requested_data/<id>', view_func=requested_data,
