...
user = Blueprint(u'user_blueprint', __name__)
...
def my_requested_data(id):
    ...
    order_by = request.query_string.decode()
    requests_new = []
    requests_open = []
    requests_archive = []
    reverse = True
...
user.add_url_rule('/user/my_requested_data/<id>',
                  view_func=my_requested_data,
                  methods=[u'GET', u'POST'])
user.add_url_rule('/user/my_requested_data/new/<username>/<request_action>',
                  view_func=handle_new_request_action,
                  methods=[u'GET', u'POST'])
user.add_url_rule('/user/my_requested_data/open/<username>/<request_action>',
                  view_func=handle_open_request_action,
                  methods=[u'GET', u'POST'])
