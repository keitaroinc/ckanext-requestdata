...
request_data = Blueprint(u'request_data_blueprint', __name__)
...
def read_request(package_id, request_id):
    context = {
        'model': model,
        'session': model.Session,
        'user': c.user
    ...
    try:
        data_request = toolkit.get_action('requestdata_request_show')(context,
                                                                      {'id': request_id, 'package_id': package_id})
...
request_data.add_url_rule(u'/request_data',
                          view_func=send_request,
                          methods=[u'GET', u'POST'])
request_data.add_url_rule(u'/request_data/dataset/<package_id>/request/<request_id>',
